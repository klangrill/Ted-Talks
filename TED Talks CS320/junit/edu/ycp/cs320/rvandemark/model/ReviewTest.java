...
public class ReviewTest {
	...
	public void setUp() {
		...
		try { video = new Video("http://www.ted.com/talks/caitlin_doughty_a_burial_practice_that_nourishes_the_planet", 2.4); }
		catch (IOException e) { e.printStackTrace(); }
		
		extractedReview = new Review(user, video, "Here's some cool review text, bruh", 23, 1);
